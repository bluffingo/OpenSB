...
$videoData = query("SELECT $userfields v.video_id, v.title, v.description, v.time, v.views, v.author FROM videos v JOIN users u ON v.author = u.id WHERE NOT v.flags = 0010 AND NOT v.flags = 0020 ORDER BY v.id DESC LIMIT ?, ?", [$min, $max]);
